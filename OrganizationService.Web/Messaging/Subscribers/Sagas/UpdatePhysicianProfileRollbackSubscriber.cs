...
{
    public class UpdatePhysicianProfileRollbackSubscriber : SagaRollbackSubscriber<UpdatePhysicianProfileRollbackEvent>
    {
        ...
        protected override bool HandleMessage(UpdatePhysicianProfileRollbackEvent content)
        {
